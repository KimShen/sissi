...
public enum OwnerConfig {
	...
	NONE, REGISTER_FIRST, REGISTER_LAST, REGISTER_ROOMNICK, REGISTER_URL, REGISTER_EMAIL, REGISTER_ALLOW, ROOMCONFIG_WHOIS, ROOMCONFIG_PERSISTENT, ROOMCONFIG_ROOMSECRET, ROOMCONFIG_SUBJECT, ROOMCONFIG_PUBLIC, ROOMCONFIG_MAXUSERS, ROOMCONFIG_AFFILIATION;
