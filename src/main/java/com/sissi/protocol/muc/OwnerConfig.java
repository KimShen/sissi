...
public enum OwnerConfig {
	...
	NONE, REGISTER_FIRSET, REGISTER_LAST, REGISTER_ROOMNICK, REGISTER_URL, REGISTER_EMAIL, REGISTER_ALLOW, ROOMCONFIG_WHOIS, ROOMCONFIG_ROOMSECRET, ROOMCONFIG_SUBJECT, ROOMCONFIG_MAXUSERS, ROOMCONFIG_AFFILIATION;
