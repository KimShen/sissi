 ...
 */
public class MessageMuc2InviteCheckConfigProcessor extends ProxyProcessor {
	...
	public MessageMuc2InviteCheckConfigProcessor(MucConfigBuilder mucConfigBuilder) {
		super();
