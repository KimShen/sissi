...
public class PresenceMucJoin2SelfsProcessor extends ProxyProcessor {
	...
	public boolean input(JIDContext context, Protocol protocol) {
		super.broadcast(context.jid(), super.build("aaaaa@group.sissi.pw/12345"), Presence.class.cast(protocol).clear().add(new XUser().add(new Item(ItemAffiliation.MEMBER, ItemRole.PARTICIPANT))));
		return false;
	}
}
